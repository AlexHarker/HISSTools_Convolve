...
/*
 ...
 Windows7: C:\Users\USERNAME\AppData\Local\AHConvN\settings.ini
 Windows XP/Vista: C:\Documents and Settings\USERNAME\Local Settings\Application Data\AHConvN\settings.ini
 OSX: /Users/USERNAME/Library/Application\ Support/AHConvN/settings.ini
...
#include "../AHConvN.h" // change this to match your iplug plugin .h file
...
extern std::vector<unsigned int> gAudioDevNInputs;
extern std::vector<unsigned int> gAudioDevNOutputs;
extern std::vector<std::string> gMIDIInputDevNames;
extern std::vector<std::string> gMIDIOutputDevNames;

extern unsigned int gNumInputs;
extern unsigned int gNumOutputs;
