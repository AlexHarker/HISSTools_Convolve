...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=HISSToolsConvolve Demo Installer\n"
      else:
        line="OutputBaseFilename=HISSToolsConvolve Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the HISSToolsConvolve Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the HISSToolsConvolve installer\n"

    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=HISSToolsConvolve Demo installer\n"
     else:
       line="SetupWindowTitle=HISSToolsConvolve installer\n"
