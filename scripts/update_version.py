...
def main():
  ...
  plistpath = scriptpath + "/resources/HISSToolsConvolve-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HISSToolsConvolve-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HISSToolsConvolve-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HISSToolsConvolve-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HISSToolsConvolve-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/HISSToolsConvolve.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/HISSToolsConvolve.iss",inplace=1):
